...
if (isset($_POST['registrar_entrada'])) {
    include "../controller/registrar_entrada.php";
    exit();
}

if (isset($_POST['registrar_saida'])) {
    include "../controller/registrar_saida.php";
    exit();
}
...
<body>
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <select name="carimbo_loja">
                    ...
                    <?php
                    include "../controller/carimbo_de_loja.php";
                    ?>
                </select>
            </div>
            <div class="form-group">
        ...
        <form method="POST" action="visualizar_carros.php">
            <div class="form-group">
